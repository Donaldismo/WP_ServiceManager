...
class WtServiceWidget_ extends WP_Widget {

    private $template = '_wp_service_item.php';
    ...
    function __construct() {
        ...
        parent::__construct( 'wp_service_widget', 'Услуги',  $widget_ops);
    }
    ...
    public function widget( $args, $instance ) {
        ...
        if (file_exists($theme_root.'/_wp_service_item.php'))
            $this->template = $theme_root.'/_wp_service_item.php';
